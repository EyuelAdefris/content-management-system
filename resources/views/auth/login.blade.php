<x-guest-layout>
    <x-slot name="wrapperClass">min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8</x-slot>
    <x-slot name="cardClass">bg-white rounded-2xl shadow-xl overflow-hidden max-w-4xl w-full flex flex-col md:flex-row animate-fade-in</x-slot>
    ...
    <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 to-green-500 p-12 text-white relative overflow-hidden flex-col justify-between">
        ...
        <div class="relative z-10 my-auto space-y-4">
            <h2 class="text-3xl font-bold leading-tight">Welcome Back</h2>
    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1 mb-6">Enter your details to access your account</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-text-input id="email" class="block mt-1.5 w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
            ...
            <div>
                ...
                <div class="relative mt-1.5">
                    <x-text-input id="password" class="block w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm pr-10" type="password" name="password" required autocomplete="current-password" />
                    <button type="button" id="toggle-password" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600 focus:outline-none cursor-pointer" aria-label="Toggle password visibility">
            ...
            <div class="space-y-4 pt-2">
                <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white rounded-lg py-2.5 font-semibold transition-all duration-200 hover:scale-[1.02] transform shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    {{ __('Log in') }}
                </button>
